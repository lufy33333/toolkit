...
export function HtmlFormatter() {
  ...
  const tool = tools.find(t => t.id === '12');
  const isFavorite = favorites.includes('12');
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <button onClick={formatHtml} className="flex-1 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-blue-500/25 transition-all">
                格式化
              </button>
              <button onClick={minifyHtml} className="flex-1 py-3 bg-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-300 transition-all">
                压缩
              </button>
            </div>
          </div>
